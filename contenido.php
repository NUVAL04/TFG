<?php
    ...
    echo "<br><table align='center' border=0 width='80%' bgcolor='white'>
        <tr><td colspan='3'><b><U>ASUNTO:</U> <I>$asunto</b></I><td><td align=center rowspan=3>".boton_ficticio("Responder","nuevovaloracion.php?&num_valoracion=$num_valoracion")."</td></tr>
